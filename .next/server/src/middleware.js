...
var import_auth_helpers_shared = __webpack_require__(73);
var supabase;
function createClientComponentClient({ supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __webpack_require__(73);
...
function createPagesServerClient(context, { supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __webpack_require__(73);
...
function createMiddlewareClient(context, { supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __webpack_require__(73);
...
function createServerComponentClient(context, { supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __webpack_require__(73);
...
function createRouteHandlerClient(context, { supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://supabase-demo-placeholder.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRlbW8iLCJyb2xlIjoiYW5vbiIsImlhdCI6MTYyMDY0OTAyNywiZXhwIjoxOTM2MjI1MDI3fQ.OxWh8U4TMTDrxmcTYjIaZMtTp-NVw-9i-8s0JnQbLwA", options, cookieOptions } = {}) {
...
// @ts-ignore
const node_fetch_1 = __importDefault(__webpack_require__(501));
const PostgrestError_1 = __importDefault(__webpack_require__(30));
...
const PostgrestQueryBuilder_1 = __importDefault(__webpack_require__(575));
const PostgrestFilterBuilder_1 = __importDefault(__webpack_require__(260));
const constants_1 = __webpack_require__(517);
/**
 * PostgREST client.
 *
...
const PostgrestTransformBuilder_1 = __importDefault(__webpack_require__(103));
...
const PostgrestBuilder_1 = __importDefault(__webpack_require__(356));
...
const version_1 = __webpack_require__(416);
...
const PostgrestClient_1 = __importDefault(__webpack_require__(264));
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 501)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var cjs = __webpack_require__(957);
...
class RealtimeClient {
     ...
     */ connect() {
        ...
        Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 312, 23)).then(({ default: WS })=>{
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 501))).Response;
        }
        return Response;
    });
...
var browser = __webpack_require__(501);

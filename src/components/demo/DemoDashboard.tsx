...
import { Car, BarChart2, QrCode, Calendar, Users } from 'lucide-react';
...
export default function DemoDashboard() {
  ...
  // Navigation items without Settings and Sign Out
  const navItems = [
  ...
  return (
    <NotificationProvider demoMode={true}>
      <div className="flex h-[600px] bg-gray-100 overflow-hidden border border-gray-200 rounded-lg shadow-xl">
        {/* Demo badge */}
        ...
        <div className="w-64 bg-white shadow-md">
          <div className="p-6">
            <div className="flex flex-col items-center">
              <img src="/ghostlot2.png" alt="GhostLot Logo" className="h-16 w-16" />
            </div>
          </div>

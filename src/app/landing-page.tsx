...
<head>
    ...
    <title>GhostLot™ - Don't Ghost Your Leads</title>
    ...
    <meta property="og:title" content="GhostLot™ - Don't Ghost Your Leads">
    ...
    <meta property="og:image:alt" content="GhostLot - Don't Ghost Your Leads">
    <meta property="og:site_name" content="GhostLot™">
    
    <!-- Twitter -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:url" content="https://ghostlot.com">
    <meta name="twitter:title" content="GhostLot™ - Don't Ghost Your Leads">
    ...
    <meta name="twitter:image" content="https://ghostlot.com/opengraph-2.webp">
    <meta name="twitter:image:alt" content="GhostLot - Don't Ghost Your Leads">
...
<body>
    ...
    <section class="section" id="demo" aria-label="GhostLot Dealership Demo" style="background: radial-gradient(circle at center, var(--gray-dark), var(--darker));">
        <div class="container">
            ...
            <div id="dashboard-demo-container"></div>
            <script>
              document.addEventListener('DOMContentLoaded', function() {
                const script = document.createElement('script');
                script.src = '/landing-demo.js';
                script.async = true;
                script.onload = function() {
                  // The script will handle mounting the React component
                };

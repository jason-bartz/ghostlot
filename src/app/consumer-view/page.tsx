...
export default function ConsumerView() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white py-2 shadow-sm relative overflow-x-auto stats-banner">
        <div className="flex items-center justify-between max-w-md mx-auto px-4 space-x-2 text-xs text-gray-700 stats-banner-content">
          <div className="flex items-center stats-banner-item">
